    ...
    function geneRate(){
        ...
        for (let i = 0; i < 3; i++) {
          ...
          if (i === 0) {
            ...
            span.setAttribute("class", "cover");

            h2.appendChild(span);
            h2.textContent = "The food you've always dreamt of";

            p.appendChild(span);
            p.textContent = `Lorem ipsum dolor sit  amet consectetur adipisicing elit. Magni,
